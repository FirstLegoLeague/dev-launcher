...
exports.Main = class Main {
  ...
  start () {
    return this.resolveOptions()
      .tap(options => {
        const mhubService = new MhubService(options, logger)
      ...
      .tap(options => {
        const configurator = new Configurator(options, logger)
        this._services.push(configurator)

        return configurator.start()
      })
      .tap(options => {
        const primaryModule = new PrimaryModule(options, logger)
